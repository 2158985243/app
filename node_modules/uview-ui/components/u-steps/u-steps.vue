		...
		>
			...
			>
				...
				>
					...
					<u-icon v-else size="24" color="#ffffff" :name="icon"></u-icon>
				</view>
				...
				<view class="title-nav">
					...
					<text class="line-center">需要积分{{item.promotion_point}}</text>
					<text class="line-bottom" v-if="Number(item.discount)==1">商品无折扣</text>
					<text class="line-bottom" v-else>商品{{(Number(item.discount)*10).toFixed(2)}}折</text>
				</view>

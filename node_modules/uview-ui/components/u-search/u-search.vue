	...
	<view class="u-search" @tap="clickHandler" :style="{
		...
		<view class="u-content" :style="{
			...
			<view class="u-icon-wrap">
				<u-icon class="u-clear-icon" :size="35" :name="searchIcon" :color="searchIconColor ? searchIconColor : color"></u-icon>
			</view>
			<input confirm-type="search" @blur="blur" :value="value" @confirm="search" @input="inputChange" :disabled="disabled"
			 @focus="getFocus" :focus="focus" :maxlength="maxlength" placeholder-class="u-placeholder-class" :placeholder="placeholder"
			...
			<view class="u-close-wrap" v-else-if="!keyword && scan" @tap="gotoInventory">
				<u-icon name="scan" class='icon' color="#2979ff" size="45"></u-icon>
			</view>
		</view>

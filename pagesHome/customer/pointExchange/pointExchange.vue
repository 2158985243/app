	...
	<view class="pointExchange">
		...
		<view class="shopping-cart">
			<view class="goods-quantity">
				...
				<text class="money-cart">{{goodsNumber+'件'}} {{allMoney}}积分</text>
			</view>
			...
			<view class="specification" v-if="goodsOf">
				<view class="goods-of">
					...
					<view class="goodsNews">
						...
						<text class="goods-money">{{goodsOf.retail_price}}积分</text>
					</view>
				</view>
				<u-line color="#e6e6e6" />
					...
					<view class="specification" v-for="(item,index) in saveData" :key="index">
						...
						<view class="goods-of" v-if="item.goodsData[0]">
							...
							<view class="goodsNews">
								...
								<text class="goods-money">{{item.goodsData[0].goodsOf.retail_price}}积分</text>
							</view>
						</view>
